        ...
        <div className="bg-bg2 border border-border p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 bg-lime text-black font-mono text-[9px] font-bold tracking-[.2em] uppercase hover:bg-[#d4ff5c] transition-colors disabled:opacity-60 flex items-center justify-center gap-2 mt-2"
            >
              {loading ? (
